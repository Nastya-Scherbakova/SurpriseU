...
export class TestProfile extends React.Component {
    render() {
        ...
        return <div className="profile2">
            ...
            <div className='img-1'></div>  <div className='img-2'></div>  <div className='img-3'></div>
            ...
            <div className='user d-flex flex-column justify-content-center'>
                {Edit}
                <div className="info d-flex align-items-around">
                    ...
                    <div className="other-data d-flex flex-column justify-content-center">
...
const Heart = <div className='items-border'><svg version="1.1" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" viewBox="0 0 455.111 455.111" width='5vh' height='5vh' >
    <defs>
...
const Edit = <div className='edit'><svg version="1.1" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" viewBox="0 0 478.703 478.703" width='5vh' height='5vh' >
    <g>
		...
		<path stroke="url(#gradient4)" className="cake"  d="M239.4,136.001c-57,0-103.3,46.3-103.3,103.3s46.3,103.3,103.3,103.3s103.3-46.3,103.3-103.3S296.4,136.001,239.4,136.001 z M239.4,315.601c-42.1,0-76.3-34.2-76.3-76.3s34.2-76.3,76.3-76.3s76.3,34.2,76.3,76.3S281.5,315.601,239.4,315.601z"/>
    </g>
</svg></div>;
